...
class ExameValorForm(forms.Form):
    """
    Linha do formulário dinâmico "Exames e Valores".

    Campos opcionais para permitir que o utilizador adicione linhas sem
    necessariamente preencher todas antes de submeter.
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Usa apenas exames ativos para o registo de valores.
